...
import configScreen from './routers/internal/config.js';
...
import linkpreviews from './routers/internal/linkPreviews.js';
...
app.use('/food', food);
app.use('/games', games);
app.use('/linkpreviews', linkpreviews);
